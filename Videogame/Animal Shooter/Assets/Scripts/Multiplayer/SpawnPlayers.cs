...
{
    public GameObject blueRaccoonPrefab;
    public GameObject redRaccoonPrefab;
    public GameObject blueRatPrefab;
    public GameObject redRatPrefab;

    // public GameObject redcatPrefab;
